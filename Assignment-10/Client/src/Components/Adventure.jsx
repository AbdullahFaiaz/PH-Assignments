...
const [adventures, setAdventures] = useState([])
  useEffect(() => {
    const fetchData = async () => {
        try {
            const response = await fetch("https://server-five-pearl.vercel.app/adventures");
  ...
  return (
    <div>
      ...
      <h2 className="text-[#0d0a05 text-[4.6vw] lg:text-[3vw] pb-[1.5vw] font-bold text-center">Adventure Activities</h2>
    <section  style={{ backgroundImage: `url(${coolbg})` , backgroundAttachment: "fixed"}} className="bg-cover bg-center py-[9vw]">
