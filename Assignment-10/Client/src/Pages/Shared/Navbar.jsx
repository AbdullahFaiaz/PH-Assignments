...
//night mode ends
    ...
    const navLinks = <>
        ...
        <NavLink to="/spots"> <span>All Tourists Spots</span></NavLink>
        {user && <NavLink to="/add"><span>Add Tourists Spot</span></NavLink>}
        {user && <NavLink to={`/mySpots/${user.email}`}><span>My List</span></NavLink> }
  ...
  return (
    <div className="bg-cover bg-bottom text-[3vw] sm:text-[2.5vw] md:text-[1.7vw] lg:text-[1.3vw]" style={{ backgroundImage: `url(${footerImage})` }} >
...
<div className="dropdown z-40">
                        ...
                        {isDropdownOpen && (
                            ...
                            >
                                ...
                                <li><NavLink to="/spots">All Tourists Spots</NavLink></li>
                                {user && <li><NavLink to="/add">Add Tourists Spot</NavLink></li>}
                                {user && <li><NavLink to={`/mySpots/${user.email}`}>My List</NavLink></li>}
                                {!user && (
                                    <>
