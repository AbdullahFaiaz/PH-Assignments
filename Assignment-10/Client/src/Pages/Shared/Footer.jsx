...
const Footer = () => {
    return (
        <footer className="bg-cover text-[2vw] lg:text-[1vw] bg-bottom relative py-12 md:py-16 lg:py-20" style={{ backgroundImage: `url(${footerImage})`, backgroundAttachment: "fixed" }}>
