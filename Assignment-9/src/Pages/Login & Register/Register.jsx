...
const Register = () => {
    ...
    const {setShowToast,setLog} = useContext(AuthContext)
  ...
  // //handle Sample log in button and toast
  // const handleClick = () => {
  ...
  return (
    <div className="flex justify-center items-center py-8 md:py-12 lg:py-16 bg-white">
        <Helmet>
            <title>Harmony Homes | Register</title>
        </Helmet>
        <ToastContainer />
